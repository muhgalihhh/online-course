...
export default function PaymentIndex({ auth, course, clientKey, isProduction, transaction: initialTransaction, error: initialError, isAlreadyEnrolled, isAlreadyPaid, transactionExpired, expiredMessage }: Props) {
    // State management
                                ...
                                <CardContent>
                                    ...
                                    <div className="mb-6 flex items-center gap-3 rounded-lg bg-gray-50 p-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            {transactionExpired && expiredMessage && (
                                                <p className="mt-1 text-xs text-orange-600">{expiredMessage}</p>
                                            )}
                                    ...
                                    {isAlreadyEnrolled ? (
                                        <div className="flex flex-col items-center justify-center py-12">
                                            ...
                                            <Button onClick={() => router.visit(`/courses/${course.id}/learn`)}>
                                                Mulai Belajar
                                            </Button>
                                        </div>
                                    ) : isAlreadyPaid ? (
                                            ...
                                            {snapToken && transaction && paymentStatus === 'pending' && (
                                                <div className="mt-3 text-center">
                                                    <p className="text-xs text-gray-500">
                                                        Tidak melihat form pembayaran? Klik "Muat Ulang Form"
                                                    </p>
                                                    <p className="text-xs text-gray-500">
