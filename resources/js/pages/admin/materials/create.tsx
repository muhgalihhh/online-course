...
export default function CreateMaterial({ chapters, course_id, chapter_id }: CreateMaterialProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        console.log('Validation passed, submitting to:', route('admin.materials.store'));
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid gap-4 md:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                {course_id && <p className="mt-1 text-sm text-muted-foreground">Course telah dipilih dan tidak dapat diubah</p>}
                            </div>
