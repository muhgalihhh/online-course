            ...
            <div className="space-y-6">
                ...
                <div className="mb-6 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        <Link href={route('admin.courses.edit', course.id)}>
                            <Button variant="outline">Edit Kursus</Button>
                        </Link>
                ...
                <Card className="overflow-hidden">
                    <div className="grid gap-6 md:grid-cols-3">
                        ...
                        <div className="md:col-span-1">
                            <div className="relative m-6 aspect-video overflow-hidden rounded-lg bg-gradient-to-br from-primary/10 to-primary/5 md:aspect-square">
                                {course.thumbnail || course.thumbnail_path ? (
                                    ...
                                    <div className="flex h-full w-full items-center justify-center">
                                        <div className="text-center">
                                            <ImageIcon className="mx-auto mb-2 h-16 w-16 text-muted-foreground/50" />
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{course.chapters.reduce((sum, ch) => sum + ch.course_materials_count, 0)}</div>
                    ...
                    <TabsContent value="chapters">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Semua chapter dan materi dalam kursus ini</CardDescription>
                            </CardHeader>
                            <CardContent>
                                {course.chapters.length > 0 ? (
                                    <div className="space-y-2">
                                        {course.chapters.map((ch, index) => (
                                            <Link key={ch.id} href={route('admin.chapters.show', ch.id)} className="block">
                    ...
                    <TabsContent value="students">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Daftar pengguna yang terdaftar dalam kursus ini</CardDescription>
                            </CardHeader>
                            <CardContent>
