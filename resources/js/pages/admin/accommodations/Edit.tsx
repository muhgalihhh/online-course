...
export default function AccommodationEdit({ accommodation, institutions }: AccommodationEditProps) {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        post(route('admin.accommodations.update', accommodation.id), {
            forceFormData: true,
            preserveScroll: true,
        });
    };

    const currentImage = imagePreview || accommodation.image_url;

    return (
        <AdminLayout>
            <Head title={`Edit Akomodasi - ${accommodation.name}`} />
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">Edit Akomodasi</h1>
                        <p className="text-muted-foreground">Edit informasi akomodasi "{accommodation.name}"</p>
                    </div>
                </div>
                        ...
                        <div className="space-y-6">
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    {currentImage && (
                                        <div className="space-y-2">
                                            <Label>{imagePreview ? 'Preview Gambar Baru' : 'Gambar Saat Ini'}</Label>
                            ...
                            <div className="space-y-2">
                                ...
                                <Button type="button" variant="outline" className="w-full" asChild>
                                    <Link href={route('admin.accommodations.index')}>Batal</Link>
                                </Button>
                            </div>
                        </div>
                    </div>
